...
-- registros usuarios
call sp_usuarios_create('admin','Roberto','Gómez','roberto.g@empresa.com','123','admin','2026-01-10');
...
call sp_usuarios_create('tilin','Elena','Paz','elena.paz@blog.com','123','vendedor','2026-02-01');
...
call sp_publicaciones_create('Venta de Garage', 'Muebles y electrodomésticos en buen estado.', 'Calle 10 #5-20', null, 5551234, 'ventas@correo.com', '09:00 - 18:00', '2026-01-15', 'aceptado', 1, 1);
call sp_publicaciones_create('Fontanero Express', 'Reparación de tuberías y fugas de agua.', 'Av. Central 45', null, 5559876, 'plomeria@web.com', '24 Horas', '2026-01-18', 'pendiente', 2, 2);
call sp_publicaciones_create('Clases de Guitarra', 'Nivel básico e intermedio para niños y adultos.', 'Barrio San Juan', null, 5554433, 'musica@clases.com', '14:00 - 20:00', '2026-01-20', 'aceptado', 3, 3);
call sp_publicaciones_create('Apartamento Amueblado', '2 habitaciones, cerca del centro comercial.', 'Edificio Las Palmas', null, 5552211, 'rentas@inmuebles.com', 'Lunes a Viernes', '2026-01-25', 'aceptado', 4, 4);
call sp_publicaciones_create('Paseador de Perros', 'Caminatas diarias en parques locales.', 'Sector Norte', null , 5556677, 'canino@amigos.com', '07:00 - 11:00', '2026-02-01', 'pendiente', 5, 5);
call sp_publicaciones_create('Menú del Día', 'Almuerzos económicos con sabor casero.', 'Carrera 8 #12-40', null , 5553322, 'cocina@delicia.com', '11:30 - 15:00', '2026-02-05', 'pendiente', 6, 6);
call sp_publicaciones_create('Tecnico PC', 'Soporte técnico y mantenimiento preventivo.', 'Calle Florida 200', null , 5551122, 'tech@soporte.com', '08:00 - 17:00', '2026-02-10', 'aceptado', 2, 7);
call sp_publicaciones_create('Bicicleta de Montaña', 'Casi nueva, marco de aluminio, rin 29.', 'Residencial El Bosque', null, 5558899, 'marcos_bici@mail.com', 'Fines de semana', '2026-02-12', 'aceptado', 1, 8);
call sp_publicaciones_create('Jardines Verdes', 'Poda de césped y diseño de paisajes.', 'Zona Rural 5', null, 5550011, 'jardin@verdes.com', '06:00 - 14:00', '2026-02-15', 'pendiente', 5, 9);
call sp_publicaciones_create('Asesoría Digital', 'Estrategias para redes sociales y SEO.', 'Oficina Virtual', null, 5557788, 'mkt@estrategia.com', 'Cita previa', '2026-02-20', 'aceptado', 7, 10);
...
call sp_agregar_servicios('Paseos en lancha "El Quetzal"', 'Ofrecemos paseos en lancha privados y compartidos por el Lago Petén Itzá, con paradas en los puntos más emblemáticos de la zona, como el mirador del Rey Canek, el zoológico Petencito y la comunidad de San Miguel.', 12345678,"C:\Users\danie\Downloads\ImagenesDB\Servicios\Servicio1.png", '2023-11-20', 1);
